...
import { SignupFormValues, signupSchema } from "@/schemas/auth/signIn-and-signup"; // adjust path as needed
...
const SignUpForm = () => {
  ...
  const onSubmit = (data: SignupFormValues) => {
    startTransition(async () => {
      ...
      if (!result.success) {
        // You can handle error display via state or toast
        return;
      }
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="w-full max-w-lg mx-auto sm:p-8 p-10 border rounded-2xl shadow-xs">
        <div className="mb-8">
          <h1 className="text-[32px] font-bold text-[#82111b] mb-2 tracking-tight">Create an Account</h1>
          <p className="text-[15px] font-medium text-[#6B6565]">Please sign up to join Luxe.</p>
        </div>
